...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
       ...
       array(
            ...
            'version'            => '1.3.2', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
...
global $imic_options;
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'activate_link'                   => _n_noop( 'Begin activating plugin', 'Begin activating plugins', 'framework' ),
